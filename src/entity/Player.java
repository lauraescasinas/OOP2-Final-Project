           ...
           // event triggerrs
            ...
            if (gp.gsManager.getCurrentMap() == gp.MAP_HOUSE) {
                if (gp.gsManager.getCurrentQuest() == 5 && gp.gsManager.getHouseEventState() < 7) {
                    if (playerHitbox.intersects(gp.tempBtnHitbox)) {
                        gp.gsManager.setHouseEventState(7); gp.gsManager.setDemonVisible(true); gp.dlgManager.startDialogue(gp.dlgManager.houseDialogue3);;
                    }
                } else if (gp.gsManager.getHouseEventState() == 0) {
                    if (playerHitbox.intersects(gp.tempBtnHitbox)) {
                        gp.gsManager.setHouseEventState(1); gp.dlgManager.startDialogue(gp.dlgManager.houseDialogue1);
                    }
                }
            }
            ...
            if (gp.gsManager.getCurrentMap() == gp.MAP_ROOM) {
                ...
                if (playerHitbox.intersects(gp.cManager.houseDoorHitbox) && gp.gsManager.getCurrentQuest() >= 1) {
                    gp.gsManager.setCurrentMap(gp.MAP_STREET); direction = "down";
                    ...
                    gp.gsManager.setCurrentMap(gp.MAP_ROOM); direction = "left";
                ...
                if (playerHitbox.intersects(gp.cManager.workshopDoorHitbox)) {
                    gp.gsManager.setCurrentMap(gp.MAP_STREET); direction = "left";
                ...
                if (playerHitbox.intersects(gp.cManager.greenhouseDoorHitbox)) {
                    gp.gsManager.setCurrentMap(gp.MAP_STREET); direction = "right";
                ...
                if (playerHitbox.intersects(gp.cManager.streetHouseDoorHitbox)) {
                    gp.gsManager.setCurrentMap(gp.MAP_HOUSE); direction = "up";
                    ...
                    gp.gsManager.setCurrentMap(gp.MAP_MUSEUM); direction = "up";
                    ...
                    gp.gsManager.setCurrentMap(gp.MAP_WORKSHOP); direction = "up";
                    ...
                    gp.gsManager.setCurrentMap(gp.MAP_GREENHOUSE); direction = "up";
